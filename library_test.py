...
class TestExtractISO8601(unittest.TestCase):
    ...
    def test_months_30(self):
        ...
        self.assert_extract("I was born on 2015-09-31.", library.dates_iso8601, "")
        self.assert_extract("I was born on 2015-11-31.", library.dates_iso8601, "")
    ...
    def test_months_31(self):
        ...
        self.assert_extract("I was born on 2015-08-31.", library.dates_iso8601, "2015-08-31")
        self.assert_extract("I was born on 2015-10-31.", library.dates_iso8601, "2015-10-31")
    ...
    def test_no_dash_years(self):
        self.assert_extract("I was born on -294-01-01.", library.dates_iso8601, "")

    def test_invalid_seperator(self):
        self.assert_extract("I was born on 1845:04:10", library.dates_iso8601, "")

    def test_multiple_addresses(self):
        self.assert_extract("I was born on 2015-07-25, not on 2015-07-26.", library.dates_iso8601, "2015-07-25", "2015-07-26")
        self.assert_extract("I was not born on 2015-13-02 because it is invalid, but on 2000-12-01", library.dates_iso8601, "2000-12-01")
...
class TestValidDate(unittest.TestCase):
    ...
    def test_months_30(self):
        ...
        self.test_date((2000, 9, 31), False)
        self.test_date((2000, 11, 31), False)
    ...
    def test_months_31(self):
        ...
        self.test_date((2000, 8, 31), True)
        self.test_date((2000, 10, 31), True)
        self.test_date((2000, 12, 31), True)
